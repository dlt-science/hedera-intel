...
# Load the data
file_path = os.path.join(RESULTS_PATH, "hourly_data_counts.csv")
...
# Update the layout
fig.update_layout(title={'text': 'Transaction Counts by Type Over Time',
                         'y':0.98,
                         'x':0.5,
                         'xanchor': 'center',
                         'yanchor': 'top'},
...
fig.write_html(path.join(FIGURES_PATH, "transaction_counts_by_type_over_time.html"))
